...
def test(model,args,valLoader):
    ...
    for k,sample in enumerate(tqdm(valLoader)):
        ...
        labels = labels.float()
        with torch.no_grad():
            predict_d1, predict_d2 = model(u_node,i_node,neg_samples,seq_d1,seq_d2,long_tail_mask_d1,long_tail_mask_d2,False)
...
if __name__ == '__main__':
    ...
    for i in range(5):
        ...
        datasetTrain = DualDomainSeqDataset(seq_len=args.seq_len,isTrain=True,neg_nums=args.neg_nums,long_length=args.long_length,pad_id=item_length+1,csv_path="/ossfs/workspace/CDSR/{}_dataset/{}_train".format(args.dataset_type,args.domain_type)+str(int(args.overlap_ratio*100))+".csv")
        ...
        datasetVal = DualDomainSeqDataset(seq_len=args.seq_len,isTrain=False,neg_nums=args.neg_nums,long_length=args.long_length,pad_id=item_length+1,csv_path="/ossfs/workspace/CDSR/{}_dataset/{}_test.csv".format(args.dataset_type,args.domain_type))
        ...
        if args.model.lower() == "gru4rec":
            model = GRU4Rec(user_length=user_length, user_emb_dim=args.emb_dim, item_length=item_length, item_emb_dim=args.emb_dim, seq_len=args.seq_len, hid_dim=args.hid_dim, bs=args.bs, isInC=args.isInC, isItC=args.isItC, threshold1=args.ts1, threshold2=args.ts2).cuda()
        elif args.model.lower() == "sasrec":
            model = SASRec(user_length=user_length, user_emb_dim=args.emb_dim, item_length=item_length, item_emb_dim=args.emb_dim, seq_len=args.seq_len, hid_dim=args.hid_dim, bs=args.bs, isInC=args.isInC, isItC=args.isItC, threshold1=args.ts1, threshold2=args.ts2).cuda()
        ...
        if not args.overlap:
            ...
            best_hit_1_d1_ov, best_hit_5_d1_ov, best_hit_10_d1_ov, best_ndcg_5_d1_ov, best_ndcg_10_d1_ov, best_mrr_d1_ov, best_hit_1_d1_no, best_hit_5_d1_no, best_hit_10_d1_no, best_ndcg_5_d1_no, best_ndcg_10_d1_no, best_mrr_d1_no, best_hit_1_d2_ov, best_hit_5_d2_ov, best_hit_10_d2_ov, best_ndcg_5_d2_ov, best_ndcg_10_d2_ov, best_mrr_d2_ov, best_hit_1_d2_no, best_hit_5_d2_no, best_hit_10_d2_no, best_ndcg_5_d2_no, best_ndcg_10_d2_no, best_mrr_d2_no, best_hit_1_d1, best_hit_5_d1, best_hit_10_d1, best_ndcg_5_d1, best_ndcg_10_d1, best_mrr_d1, best_hit_1_d2, best_hit_5_d2, best_hit_10_d2, best_ndcg_5_d2, best_ndcg_10_d2, best_mrr_d2    = train(model,trainLoader,args,valLoader)
            # test(model,args,valLoader)
